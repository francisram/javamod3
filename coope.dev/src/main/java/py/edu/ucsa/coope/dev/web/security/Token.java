...
@NamedQuery(name = "Token.getTokenActivoPorIdUsuario", query = "SELECT t FROM token t inner join Usuario u on t.usuario.id = u.id WHERE u.id = :id and (t.expirado = false or t.renovado = false")
